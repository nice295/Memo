...
import com.kgu.UNIMEMO.Audio_Cuttermaster.CheapSoundFile;
import com.kgu.UNIMEMO.Audio_Cuttermaster.Util;
...
private String real;
    ...
    public Record_item mNewRecordItem;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Record_item> formats = new ArrayList<>();
        mList = new ArrayList<>();
        // formats = getData();
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                fileName ="Original record"+ii+ ".3gp";
                try {
            ...
            public void onClick(View view) {
                ...
                if (myAudioRecorder != null) {
                    ...
                    try {
                        ...
                        int startFrame = Util.secondsToFrames(endTime - 300.0, mSampleRate, mSamplesPerFrame);
                        ...
                        if (endTime > 300) {
                            String fileName_2="cut file"+ii+".3gp";
                            File mRecodeFile_2 = new File(myDataPath+"/" + fileName_2);
                            File outFile = new File(mRecodeFile_2.getAbsolutePath());
                ...
                fileName ="Original record"+ii+ ".3gp";
             //   mNewRecordItem.setfileTitle(fileName);
                try {
                    File SDCardpath = Environment.getExternalStorageDirectory();
                    myDataPath = new File(SDCardpath.getAbsolutePath() + "/Unimemo/녹음");
                    if (!myDataPath.exists())
...
*/
        ...
        mNewRecordItem = new Record_item(i, DATE(),"","");
    }
        ...
        builder.setPositiveButton(getString(R.string.yes),
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        //mNewRecordItem.setfileTitle(title);
                        folder_name = title;
                        File SDCardpath = Environment.getExternalStorageDirectory();
                        filenow = new File(SDCardpath.getAbsolutePath() + "/Unimemo/" + folder_name);
                        //filenow_2 = new String(SDCardpath.getAbsolutePath() + "/Unimemo/" + folder_name+fileName);
                        //mNewRecordItem.setfileTitle(filenow_2);
                        //Log.d(TAG, "Path()="+ filenow);
                      ...
                      /*
                        LinkedList<Record_item> FILEname = Paper.book().read(Constants.FILENAME, new LinkedList());
                        FILEname.add(mNewRecordItem);
                        Paper.book().write(Constants.FILENAME, FILEname);
*/

                        ArrayList<Record_item> formats = new ArrayList<Record_item>();
                        formats.add(mNewRecordItem);


                        LinkedList<Recycler_item> records = Paper.book().read(Constants.RECORD, new LinkedList<Recycler_item>());
...
// Now set the textchange listener for edittext
    ...
    public ArrayList<Record_item> getData() {
        ...
        Record_item li = new Record_item(i, DATE(),fileName,"");
        formats.add(li);
        return formats;
